...
% Instructions
% =====================================================
DrawFormattedText(win, 'Please wait for the instructions of the next task!', 'center', 'center');
Screen('Flip', win);
% waits for keyM
...
img = imread([folder filesep 'TappingIntro.png']);
